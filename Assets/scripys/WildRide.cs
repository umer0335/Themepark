...
public class WildRide : MonoBehaviour
{
    ...
    private bool isPaused = true;        // Controls if the ride is explicitly paused/stopped by user
    ...
    // Method to adjust the ride's speed from the UI slider
    public void SetSpeed(float newSpeed)
    {
        riseSpeed = newSpeed;  // Adjust rise speed based on slider input
        fallSpeed = newSpeed * 2.0f;  // Adjust fall speed (can be a multiplier of rise speed)
    }
